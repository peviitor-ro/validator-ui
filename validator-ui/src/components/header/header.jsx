...
export default function Header(props) {
  ...
  // Close/open menu on mobile when clicking on the menu button
  ...
  // The links prop is an array of objects with the following shape:
  // {
  //   name: "Home",
  //   url: "/",
  // }
  //
  // The links prop is optional, so we need to check if it exists before
  // mapping over it.
