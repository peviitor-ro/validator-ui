...
export default function Login() {
    ...
    return (
        <div className="flex items-center justify-around h-screen">
            ...
            <div className="flex flex-col items-center justify-around w-full sm:w-1/2 h-1/3 mx-4 bg-bg-container rounded-lg shadow-xl drop-shadow-md transform translate-x-0 md:translate-x-[-30%] ">
